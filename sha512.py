...
# ***************** round function starts ******************
    ...
    a= additionModulo(H[:64], a)
    b= additionModulo(H[64:64 * 2], b)
    c= additionModulo(H[64 * 2:64 * 3], c)
    d= additionModulo(H[64 * 3:64 * 4], d)
    e= additionModulo(H[64 * 4:64 * 5], e)
    f= additionModulo(H[64 * 5:64 * 6], f)
    g= additionModulo(H[64 * 6:64 * 7], g)
    h= additionModulo(H[64 * 7:64 * 8], h)
